      ...
      <div className="relative container mx-auto px-6 py-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            {/* Decorative icon */}
            <div className="w-14 h-14 bg-warm-yellow rounded-2xl flex items-center justify-center shadow-warm rotate-3 hover:rotate-0 transition-transform duration-300" aria-hidden="true">
          ...
          <div className="flex items-center gap-4">
            {apiKey && (
              <div className="flex items-center gap-3 bg-forest-light/50 backdrop-blur-sm px-5 py-2.5 rounded-full border border-forest-light/30" role="status" aria-label="API-status">
                <span className="w-2 h-2 bg-warm-yellow rounded-full animate-pulse" aria-hidden="true"></span>
