                  ...
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-white/50 hover:bg-coral/10 flex items-center justify-center transition-all text-warm-gray hover:text-coral"
                      ...
                      <div className="w-11 h-11 rounded-full bg-forest/10 flex items-center justify-center text-forest group-hover:bg-forest group-hover:text-cream transition-all" aria-hidden="true">
